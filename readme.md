...
# Ellenőrizendő szövegek még:

Bot name (hostname)?

Containers

Create container XXX with size YYY

Disable PPP service autostart

Enable autossh service

Enable PPP service autostart

FTP configuration (user: ftp pass: ftppass)

Hostname reconfiguration

Missing inputs for autossh service setup

Mount container XXX

Package updates

PPP connection setup with APN XXX and device YYY

Service configurations and updates

SSH reconfiguration

Swap file already exists and working
...
Unmount container XXX

VNC configuration on :1 with password vncpass (systemctl status 4Gbot-vnc-server@1.service)

What is your operator name?

What is your operator APN?

What is your device communication PORT? (like ttyUSB3)?

What is your keyfile name (in /root/.ssh/)?

What is your master server IP address?

What is your master server ssh port?

What is your master server vnc port?

You did not choose y/n!
